...
folders = ["acapella", "african", "american-pop", "bollywood", "chinese", "indian-classical", "latin", "no-lyrics", "offbeat", "rap"]
...
html_code = "<center><table border=1><tr><b><td>Genre</td><td>Song Name</td><td>Audio</td><td>Duration (secs)</td><td>Music Matrix</td></b></tr>"

for i in range(len(songs)):
    row_data = "<td>%s</td><td>%s</td><td><audio controls><source src=%s type='audio/mpeg'></audio></td><td>%s</td><td><img src=%s></td>" % (genres[i], songnames[i], songs[i], durations[i], music_matrices[i])
